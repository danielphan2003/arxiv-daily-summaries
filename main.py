...
def main():
    ...
    if full_report:
        full_report = f"<em><h2>This is an autogenerated issue. It uses the {config.model_name} model to generate summaries for each papers appeared below.</h2></em><br>{full_report}"
